...
//     if(driver == "SSD1306"){
//         display = new Adafruit_SSD1306(SCREEN_WIDTH, SCREEN_HEIGHT, &Wire, OLED_RST); //SSD1306Wire(DISPLAY_ADDR, SDA, SCL);
//     } else if(driver == "SH1106"){
//         display = new Adafruit_SH110X(SCREEN_WIDTH, SCREEN_HEIGHT, &Wire, OLED_RST); //new SH1106Wire(DISPLAY_ADDR, SDA, SCL);
//     } else {
//       return true;
//     }
